# Эта программа управлет констактами.
import contact
import pickle

# Глобавльные константы для пуктов меню.
LOOK_UP = 1
ADD = 2
CHANGE = 3
DELETE = 4
...
def main():
    ...
    # Инициализиировать переменную для выбора пользователя.
    choice = 0
...
def get_menu_choice():
    ...
    # Проверить выбранный пункт на доступность.
...
# объект и сохраняет его в файле констактов.
